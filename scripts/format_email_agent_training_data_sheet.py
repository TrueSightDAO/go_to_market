#!/usr/bin/env python3
"""
Readable layout for "Email Agent Training Data":
- Freeze header row 1
- Green header, column widths, wrap on snippet / long headers
- Auto filter, banded rows (removes old banding first)

Usage:
  cd market_research && python3 scripts/format_email_agent_training_data_sheet.py
"""
...
WS_TITLE = "Email Agent Training Data"
NUM_COLS = 14
...
# synced, store_key, shop, email, msg_id, thread, dir, date, subject, from, to, snippet, row, analysis
_COL_WIDTHS = [150, 200, 200, 220, 210, 100, 100, 175, 260, 220, 220, 420, 90, 220]
