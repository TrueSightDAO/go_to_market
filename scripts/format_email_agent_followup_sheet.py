...
- Snippet column: wrap text, top-align
...
NUM_COLS = 9  # matches LOG_HEADERS in sync_email_agent_followup.py
...
# Column widths (pixels) — A..I
_COL_WIDTHS = [220, 150, 200, 160, 240, 280, 170, 420, 130]
